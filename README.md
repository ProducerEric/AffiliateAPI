...
### Method: GET
>```
>https://api.parkwayparking.com/endpoint/property/details/{id}
>```
...
### Method: GET
>```
>https://api.parkwayparking.com/endpoint/property/blackouts/{id}
>```
...
### Method: DELETE
>```
>https://api.parkwayparking.com/endpoint/property/blackout/delete/{id}/{blackout_id}
>```
...
### Method: GET
>```
>https://api.parkwayparking.com/endpoint/property/scheduledpricing/{id}
>```
...
### Method: POST
>```
>https://api.parkwayparking.com/endpoint/property/addscheduledpricing
>```
### Body (**raw**)
